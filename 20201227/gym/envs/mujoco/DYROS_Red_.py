...
class DYROSRedEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, a):
        ...
        if(self.mocap_data_idx >= self.init_mocap_data_idx):
            ...
            target_data_body_delta[0] = cubic(local_time, self.mocap_data[self.mocap_data_num-2,0] + self.mocap_data[self.mocap_data_idx,0], self.mocap_data[self.mocap_data_num-2,0] + self.mocap_data[next_idx,0], self.mocap_data[self.mocap_data_num-2,1] + self.mocap_data[self.mocap_data_idx,1] - self.mocap_data[self.init_mocap_data_idx,1], self.mocap_data[self.mocap_data_num-2,1] + self.mocap_data[next_idx,1] - self.mocap_data[self.init_mocap_data_idx,1], 0.0, 0.0)
            target_data_body_delta[1] = cubic(local_time, self.mocap_data[self.mocap_data_num-2,0] + self.mocap_data[self.mocap_data_idx,0], self.mocap_data[self.mocap_data_num-2,0] + self.mocap_data[next_idx,0], self.mocap_data[self.mocap_data_idx,3] - self.mocap_data[self.init_mocap_data_idx,3], self.mocap_data[next_idx,3] - self.mocap_data[self.init_mocap_data_idx,3], 0.0, 0.0)
            target_data_body_delta[2] = cubic(local_time, self.mocap_data[self.mocap_data_num-2,0] + self.mocap_data[self.mocap_data_idx,0], self.mocap_data[self.mocap_data_num-2,0] + self.mocap_data[next_idx,0], self.mocap_data[self.mocap_data_idx,2] - self.mocap_data[self.init_mocap_data_idx,2], self.mocap_data[next_idx,2] - self.mocap_data[self.init_mocap_data_idx,2], 0.0, 0.0)
    ...
    def reset_model(self):
        ...
        self.epi_len = 0
        self.epi_reward = 0
        self.init_mocap_data_idx = np.random.randint(low=0, high=self.mocap_data_num-2)
