...
class PPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        if self.wandb_use:
            wandb.init(project="DeepMimicTorch", tensorboard=False)
        ...
        if self.wandb_use:
            if (self._n_updates % 10 == 0):
                ...
                if len(self.specific_reward_info_buffer) > 0 :
                    ...
                    wandb_dict["mimic_ee_reward"] = safe_mean([specific_reward_info['mimic_ee_reward'] for specific_reward_info in self.specific_reward_info_buffer])
